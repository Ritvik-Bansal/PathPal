        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              subsections: [
                '1.1 Registration Information\nUsers: When you register for PathPal, we collect your first and last name, email address, and password.\n\nContributors: When you continue as a Contributor, we collect travel itinerary details, including flight numbers, dates, people in the party, and travel routes, along with the already given details from the account creation.\n\nReceivers: When you register as a Receiver, we collect your reason for seeking assistance, travel itinerary details, and the number of people in your party, along with the already given details from the account creation.',
                '1.2 Usage Information\nWe collect information about how you interact with the app and the details you provide during the Contributor or Receiver flow.',
                '1.3 Communication Information\nWhen Receivers contact Contributors through the app, we collect and process the email sent to the Contributor via PathPal, which includes the Receiver\'s contact information.',
              ],
            ),
            _buildSection(
              title: '2. How We Use Your Information',
              subsections: [
                '2.1 Providing Services\nWe use your personal information to facilitate connections between Contributors and Receivers, display suitable matches, and manage user accounts.\n\nWe ensure that the Contributor\'s name and personal details remain private and are never disclosed to Receivers.',
            ...
            _buildSection(
              ...
              subsections: [
                '3.1 With Other Users\nContributors: Your travel itinerary details (excluding your name, email, and password) are shared with potential Receivers to facilitate matching. Your personal information always remains private.\n\nReceivers: Your contact information is only shared with a Contributor when you choose to contact them through the app.',
